    ...
    <div style={styles.container}>
      ...
      <div style={styles.section}>
        <div style={styles.iconList}>
          {/*  Sections Icon */}
          <div style={styles.iconItem} onClick={() => handleRedirect('/admin/add-first-exam')}>
            <FaBusinessTime  size={50} style={styles.icon} />
            <p style={styles.iconText}>First Term</p>
          </div>
           {/*  Sections Icon */}
           <div style={styles.iconItem} onClick={() => handleRedirect('/admin/add-second-exam')}>
            <FaTable  size={50} style={styles.icon} />
            <p style={styles.iconText}>Second Term</p>
          </div>

          {/*classes Icon */}
          <div style={styles.iconItem} onClick={() => handleRedirect('/admin/add-third-exam')}>
