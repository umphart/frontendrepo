...
const ThirdTerm = () => {
  ...
  const fetchStudentDetails = async (studentId) => {
    ...
    try {
      ...
      const response = await axios.get(`http://localhost:5000/api/third-term-results/${encodeURIComponent(studentId)}`);
  ...
  <>
    ...
    <p style={styles.termTitle}>Third Term Examination Result</p>
