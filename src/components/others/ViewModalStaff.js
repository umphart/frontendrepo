    ...
    <div style={styles.container}>
      ...
      <div style={styles.section}>
        <div style={styles.iconList}>
          {/*  Sections Icon */}
          <div style={styles.iconItem} onClick={() => handleRedirect('/staff/first-term')}>
            <FaEye size={50} style={styles.icon} />
            <p style={styles.iconText}>First Term</p>
          </div>
           {/*  Sections Icon */}
           <div style={styles.iconItem} onClick={() => handleRedirect('/staff/second-term')}>
            <FaEye size={50} style={styles.icon} />
            <p style={styles.iconText}>Second Term</p>
          </div>

          {/* Classes Icon */}
          <div style={styles.iconItem} onClick={() => handleRedirect('/staff/third-term')}>
            <FaEye size={50} style={styles.icon} />
