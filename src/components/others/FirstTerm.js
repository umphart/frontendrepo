...
const navigate = useNavigate();
  ...
  const fetchStudentDetails = async (studentId) => {
    ...
    try {
      ...
      const response = await axios.get(`http://localhost:5000/api/first-term-results/${encodeURIComponent(studentId)}`);
  ...
  <>
    ...
    <p style={styles.termTitle}>First Term Examination Result</p>
